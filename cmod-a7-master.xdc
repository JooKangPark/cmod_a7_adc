...
create_clock -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {clk_12m}];
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { vauxn }]; #IO_L1N_T0_AD4N_35 Sch=ain_n[15]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { vauxp }]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
